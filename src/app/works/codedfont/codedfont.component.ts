...
@Component({
  selector: 'app-codedfont',
  templateUrl: './codedfont.component.html',
  styleUrls: ['./codedfont.component.css']
})
export class CodedfontComponent implements OnInit {
  title: string = '보는 이와 상호작용하는 폰트 <CODED FONT>';
